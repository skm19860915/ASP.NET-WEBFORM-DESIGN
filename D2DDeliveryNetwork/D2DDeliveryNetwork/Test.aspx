<%@ Page Title="" Language="C#" MasterPageFile="~/D2D.Master" AutoEventWireup="true" CodeBehind="Test.aspx.cs" Inherits="D2DDeliveryNetwork.Test" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div style="text-align: center" class="item active">
                    <div class="wrapper">
                        ...
                        <div class="carousel-caption">
                            <h2>What we do?</h2>
                            <p>We specialise in supporting the Businesses and Individuals who wants to delivery their supplies to the other part of the United States, Canada and Mexico. </p>
    ...
    --%>
<div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner "><div class="wpb_wrapper"><div class='cmo-content-box wpb_content_element clearfix text-center icon-block icon-x-large padding-none   no-hover ' id='cmo-content-box-2'><style scoped>.cmo-content-box#cmo-content-box-2 .icon{border-color:#e5e5e5;}.cmo-content-box#cmo-content-box-2 .featured-icon{border-radius:50px;}.cmo-content-box#cmo-content-box-2 .icon{border-radius:50px;}</style><div class='icon icon-border-thin' ><i class='featured-icon et-line icon-attachment '></i></div><h4 class='title'>Partner for Innovation</h4><div class='content-container'><div class='content'><ul> 
            <li><a href="/services/mobile-development-services/mobile-apps-development/">Mobile Applications</a></li> 
            <li><a href="/services/web-application-development/social-networking-development/">Social Networking Apps</a></li> 
            <li><a href="/services/rich-internet-applications/">Rich Internet Applications (RIA)</a></li> 
            <li><a href="/services/outsourcing-services/outsourced-product-development-opd/">Outsourced Product Development</a></li> 
          </ul> 
          <span class="moreInfo"><a class="cmo-button shape-round custom-margin"  href="/services/outsourcing-services/">More On Outsourcing</a></span></div></div></div>
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner "><div class="wpb_wrapper"><div class='cmo-content-box wpb_content_element clearfix text-center icon-block icon-x-large padding-none   no-hover ' id='cmo-content-box-3'><style scoped>.cmo-content-box#cmo-content-box-3 .icon{border-color:#e5e5e5;}.cmo-content-box#cmo-content-box-3 .featured-icon{border-radius:50px;}.cmo-content-box#cmo-content-box-3 .icon{border-radius:50px;}</style><div class='icon icon-border-thin' ><i class='featured-icon et-line icon-gears '></i></div><h4 class='title'>Cutting-edge Business Products</h4><div class='content-container'><div class='content'><ul>  <li><a href="/products/time-attendance/">Time & Attendance</a></li> 
            <li><a href="/products/e-commerce-storefront/">E-Commerce Storefront</a></li> 
            <li><a href="/products/web-content-management/">Web Content Management</a></li> 
            <li><a href="/products/e-learning-assesment/">E-Learning & Assessment</a></li> 
          </ul> 
          <span class="moreInfo"><a class="cmo-button shape-round custom-margin" href="/products/">More Software Products</a></span></div></div></div>
</div></div></div><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner "><div class="wpb_wrapper"><div class='cmo-content-box wpb_content_element clearfix text-center icon-block icon-x-large padding-none   no-hover ' id='cmo-content-box-4'><style scoped>.cmo-content-box#cmo-content-box-4 .icon{border-color:#e5e5e5;}.cmo-content-box#cmo-content-box-4 .featured-icon{border-radius:50px;}.cmo-content-box#cmo-content-box-4 .icon{border-radius:50px;}</style><div class='icon icon-border-thin' ><i class='featured-icon et-line icon-paintbrush '></i></div><h4 class='title'>Creative Design Solutions</h4><div class='content-container'><div class='content'><ul>  <li><a href="/services/design-services/user-interface-development/">User Interface (UI) Design</a></li> 
            <li><a href="/services/design-services/website-re-engineering/">Web Re-engineering</a></li> 
            <li><a href="/services/design-services/2d-3d-animations/">2D & 3D Animations</a></li> 
            <li><a href="/services/online-marketing-services/search-engine-marketing/">Search Engine Marketing</a></li> 
          </ul> 
          <span class="moreInfo"><a class="cmo-button shape-round custom-margin" href="/services/design-services/">More Design Solutions</a></span></div></div></div>
</div></div></div></div>
		</div> 
    </section>
